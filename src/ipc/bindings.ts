...
export const commands = {
	...
	wakePrefetch: (accountId: number) => typedError<null, string>(__TAURI_INVOKE("wake_prefetch", { accountId })),
	...
	saveInlineImage: (mimeType: string, dataBase64: string) => typedError<OutgoingAttachment, string>(__TAURI_INVOKE("save_inline_image", { mimeType, dataBase64 })),
	readInlineImage: (blobRef: string) => typedError<string, string>(__TAURI_INVOKE("read_inline_image", { blobRef })),
